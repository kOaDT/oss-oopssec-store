...
import ProfileGiftCardsClient from "./ProfileGiftCardsClient";

export const metadata = {
  title: "Your Gift Cards — OopsSec Store",
  description: "Review the gift cards you've sent from your OopsSec account.",
};

export default function ProfileGiftCardsPage() {
  return (
          ...
          <div className="container mx-auto px-4 py-16 md:py-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="text-lg text-primary-50 md:text-xl">
                Gift cards you&apos;ve sent from your account.
              </p>
            </div>
          </div>
        </section>
